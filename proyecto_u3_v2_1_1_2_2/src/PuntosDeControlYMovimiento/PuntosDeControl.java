...
public class PuntosDeControl{
    private boolean desactivadoPermanente=false;
    ...
    public void visibleCircle(Boolean visible) {
        if (desactivadoPermanente==false)
            circle.setVisible(visible);
    }
    
    /*public void deleteCircle() {
        circle.setVisible(false);
        desactivadoPermanente=true;
    }*/
    
    public void moveCircle(double moverCirculos){
        circle.setTranslateY(moverCirculos);
    }
